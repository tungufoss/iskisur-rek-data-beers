...
\note{\footnotesize
    ...
    Over the years, I've taken on diverse roles: from developing intelligent fish portioning algorithms and
    custom SQL implementations to conducting genetic research with long-range sequencing.
    I've also crafted near-real-time recommendation systems for EVE Online and led an AI research team to optimize
    travel itineraries.
    ...
    \begin{itemize}
        \item A career highlight was presenting on \emph{Legend of the Ice People} at Reykjavík Databeers, inspired by my literary podcast, \emph{ÍSKISUR}. This modern literary analysis was truly exhilarating.
        \item Some might dismiss ÍSFÓLKIÐ as 'trivial' for a distinguished conference like this.
        However, as we'll explore, a purely data-driven approach to ÍSFÓLKIÐ unveils fascinating insights.
    \end{itemize}
...
Without even realizing it, I became a well known \underline{internet cat lady}.

\bigskip  % A pause here for a slight change in topic

By 2016, I discovered a \textit{hilarious} podcast named \textbf{My Dad Wrote A Porno}.
...
\begin{frame}{About ÍSKISUR}
    \note{
      ÍSKISUR is a rather unique podcast, combining two things many wouldn't expect to find together: literature and, believe it or not, cats.
      Each episode we dive into the world of \emph{The Legend of the Ice People} by Margit Sandemo.
      This series is filled with both erotic and surreal elements, making it a treasure trove for lively discussions.

      \bigskip

      Now, here on the left, you'll see an image showcasing the internet sensations, Grumpy Cat and Lil Bub, to give you an example of
        what sort of cats are featured on our show.
      And to the right is our official podcast image on Storytel. It features myself alongside my amazing co-hosts Birna and Kristín.
...
\scriptsize{
    ...
    During the 80s, the \emph{Ísfólkið} became more than just literature; it evolved into a cultural phenomenon,
    deeply embedding itself in the collective consciousness of a generation.
    Its impact extended beyond the pages, shaping real-life naming trends in Iceland, and later on I will show the data behind that.
...
\begin{frame}{Timeline for the Legend of the Ice Cat-People}\label{timeline}
\note{
\tiny{
    ...
    \begin{itemize}
        ...
        \item Storytel continues the distribution of the audiobooks into fall of 2019.
